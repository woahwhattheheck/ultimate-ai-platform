 ...
 *
 * <p>The counters intentionally contain no user content and are safe to update from
 * concurrent request threads. Values are snapshots of the current JVM only.</p>
 */
